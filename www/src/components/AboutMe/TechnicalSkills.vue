...
const openDialog = (skill: any) => {
    ...
    if (mainScreenWindow)
        mainScreenWindow.style.overflowY = 'hidden';
...
const closeDialog = () => {
    ...
    if (mainScreenWindow)
        mainScreenWindow.style.overflowY = 'overlay';
...
<template>
        ...
        <div class="modal-window-content">
            <transition name="modal">
                <div class="box" v-show="dialog">
                    <div>
                        <Icon @click="closeDialog()" class="x-close-button" icon="tabler:eye-closed" />
    ...
    <ul v-show="false">
        <li v-for="(skill, i) in skillList as any" v-scrollanimation :key="skill.text" @click="openDialog(skill)"
