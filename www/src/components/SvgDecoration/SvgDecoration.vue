...
<template>
    <svg v-if="type === 1" :class="classNames" aria-hidden="true" width="140" height="140" viewBox="0 0 140 140">
        <g fill-rule="evenodd">
            <path
    ...
    <svg v-if="type === 3" :class="classNames" aria-hidden="true" width="116" height="116" viewBox="0 0 116 116">
        <g fill-rule="evenodd">
            <path
            ...
            <rect opacity=".238" x="36" width="80" height="80" rx="8"></rect>
        </g>
    </svg>
</template>
